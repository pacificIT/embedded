...
mkdir ~/robot2020/src
cd ~/robot2020/src
git clone -b hydro-devel https://github.com/mayfieldrobotics/robot2020.git
...
git clone https://github.com/mayfieldrobotics/mobile-base-ros-driver.git
cd ~/robot2020
set +e
rosdep install --from-paths src --ignore-src --rosdistro indigo -y
catkin_make

#install the other udev rules
